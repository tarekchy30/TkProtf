...
* @public
*/
type Id3Frame = DecodedId3Frame<ArrayBufferLike | string | number>;
//#endregion
...
* @public
*/
declare function getId3Frames(id3Data: Uint8Array): Id3Frame[];
//#endregion
...
* @public
*/
declare function getId3Timestamp(data: Uint8Array): number | undefined;
//#endregion
...
*
*/
declare function isId3TimestampFrame(frame: Id3Frame): frame is DecodedId3Frame<ArrayBufferLike>;
//#endregion
//#region src/util/RawId3Frame.d.ts
/**
* Raw ID3 frame.
*
* @internal
...
* @internal
*/
declare function toArrayBuffer(view: ArrayBufferLike | TypedArray): ArrayBufferLike;
//#endregion
//#region src/util/utf8.d.ts
/**
* @internal
*/
declare function toUint8(data: BufferSource, offset?: number, length?: number): Uint8Array;
//#endregion
...
* @internal
*/
declare function utf8ArrayToStr(array: Uint8Array, exitOnNull?: boolean): string;
//#endregion
export { DecodedId3Frame, ID3_SCHEME_ID_URI, Id3Frame, RawId3Frame, TypedArray, canParseId3, decodeId3Frame, decodeId3TextFrame, getId3Data, getId3Frames, getId3Timestamp, isId3Footer, isId3Header, isId3TimestampFrame, readId3Size, toArrayBuffer, toUint8, utf8ArrayToStr };
